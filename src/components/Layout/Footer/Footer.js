...
export default () => {
  ...
  const { author: { contacts }, menu } = useSiteMetadata()
      ...
      <Grid container spacing={3}>
        ...
        <Grid item sm={6} md={4}>
          <Typography variant="body2" color="textSecondary">
            本站作品采用<Link color="inherit" href={'http://creativecommons.org/licenses/by/4.0/'}
                        target="_blank" rel="noopener">知识共享署名 4.0 国际许可协议</Link>进行许可。
          </Typography>
        </Grid>
      </Grid>
    </footer>
