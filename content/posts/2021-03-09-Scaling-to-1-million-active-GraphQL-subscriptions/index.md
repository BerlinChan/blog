---
title: 借助 GraphQL 承载 100万并发活动订阅（实时查询）
...
- [实现 GraphQL 实时查询](#实现-graphql-实时查询)
  ...
  - [Hasura 的方法](#hasura-的方法)
    - [主意 #1：编译 一个 GraphQL 查询为单个 SQL 查询](#主意-1编译-一个-graphql-查询为单个-sql-查询)
    - [主意 #2：使授权具有声明性](#主意-2使授权具有声明性)
    - [主意 #3：在单个 SQL 查询中批处理多个实时查询](#主意-3在单个-sql-查询中批处理多个实时查询)
    - [何时执行再获取（refetch）？](#何时执行再获取refetch)
- [测试](#测试)
- [本方法的优势](#本方法的优势)
- [未来展望](#未来展望)
